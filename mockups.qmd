            ...
            "features": [
              {
                "type": "Feature",
                "properties": {
                  "input_id": "station A" # <10>
                  "id": "https://geoconnex.us/ref/gages/1000001", # <11>
                  "distance_km": 0.1 # <12>
                },
                "geometry": {
                  "coordinates": [
...
4.  the specification of the output that will be received in the response to the API POST request
5.  a set of example inputs and outputs for this API endpoint
6.  an example geojson FeatureCollection input
7.  example geojson FeatureCollection includes id property
8.  an example distance threshold input
9.  an example output geojson FeatureCollection
10. each feature includes the identifier from the input geojson that the feature is matched with
11. each feature includes its own identifier
12. each feature includes the distance between the matched feature and the input feature
:::
